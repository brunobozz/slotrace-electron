...
window.localeStrings.en = {
  ...
  registrations: {
    ...
    tracks_modal: {
      ...
      scale_label: "Scale",
      scale_placeholder: "e.g. 1:32, 1:24",
      lanes_label: "Number of Lanes",
      lanes_placeholder: "e.g. 2, 4, 6",
      lanes_config_label: "Lanes Configuration (Color & Order)",
      pick_color: "Pick color",
      color_header: "Color",
      length_label: "Length (meters)",
      length_placeholder: "e.g. 15.5",
      powerbars_label: "Zones",
      ...
      confirm_cancel_body: "You have unsaved changes. Do you really want to discard them?",
      confirm_cancel_continue: "Continue Editing",
      confirm_cancel_discard: "Discard",
